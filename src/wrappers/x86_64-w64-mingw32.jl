...
const luac_splitpath = ["bin", "luac.exe"]
...
const lua_splitpath = ["bin", "lua.exe"]
...
const liblua_splitpath = ["bin", "lua53.dll"]
...
function __init__()
    ...
    global luac_path = abspath(joinpath(artifact"Lua", luac_splitpath...))

    push!(PATH_list, dirname(luac_path))
    global lua_path = abspath(joinpath(artifact"Lua", lua_splitpath...))

    push!(PATH_list, dirname(lua_path))
    global liblua_path = abspath(joinpath(artifact"Lua", liblua_splitpath...))
